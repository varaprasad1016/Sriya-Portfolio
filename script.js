...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const fadeElements = document.querySelectorAll('.section-header, .about-text, .education, .skills-grid');
    ...
    // Add fade-in to publication and contact sections
    const otherElements = document.querySelectorAll('.publication-card, .contact-content');
...
if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
        ...
        // Create mailto link
        const mailtoLink = `mailto:muddamsetty.sriya@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(`Name: ${name}\nEmail: ${email}\n\nMessage:\n${message}`)}`;
